  ...
  parts: [
    {
      ...
      exploded: { x: 0, y: 0, z: 0 }, // 가볍게 아래로
    },
    {
      id: 'Part2',
      path: '/models/RobotArm/Part2.glb',
      assembled: { x: 0, y: 0.1, z: 0 },
      exploded: { x: 0, y: 0.3, z: 0 }, // 살짝 위로
    },
    {
      id: 'Part3',
    ...
    },
    {
      ...
      exploded: { x: -0.3, y: 2.1, z: 1.8 }, // 좌우 벌어짐도 촘촘하게
    },
    {
      id: 'Part8_R',
      path: '/models/RobotArm/Part8.glb',
